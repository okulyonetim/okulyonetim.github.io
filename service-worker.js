...
const CACHE_ADI='oy-cache-v1099';
...
const ONBELLEGE_ALINACAKLAR=[
  ...
  './css/design-system.css?v=1041','./css/design-system.css','./css/dashboard-announcement-media.css?v=921','./js/app-loader.js?v=1037','./js/modules/academic.js?v=882','./js/modules/communication.js?v=839',
