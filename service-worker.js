...
const ONBELLEGE_ALINACAKLAR = [
  ...
  './js/core/utils.js','./js/core/store.js','./js/core/event-bus.js','./js/alt-navigasyon.js','./js/alt-navigasyon-core.js','./js/alt-navigation-list-theme.js','./js/ui-stability-fixes.js',
