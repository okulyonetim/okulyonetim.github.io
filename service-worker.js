...
const ONBELLEGE_ALINACAKLAR=[
  ...
  './js/modules/rubric-settings.js','./js/modules/rubric-tools.js','./js/modules/rubric-tools-v2-engine.js','./js/modules/rubric-settings-parity.js',
