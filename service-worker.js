...
const ONBELLEGE_ALINACAKLAR = [
  ...
  './css/web-shell-fix.css','./css/web-sidebar-v2.css','./css/dashboard-yeni.css','./css/dashboard-home.css','./css/dashboard-home-colors.css','./css/alt-navigation-theme.css','./css/app-pages-theme.css',
  './js/firebase-init.js','./js/auth.js','./js/ozellik-katalogu.js','./js/app.js','./js/ui.js','./js/push.js',
  './js/core/utils.js','./js/core/store.js','./js/core/event-bus.js','./js/alt-navigasyon.js','./js/alt-navigasyon-core.js','./js/alt-navigation-list-theme.js','./js/ui-stability-fixes.js','./js/app-pages-theme.js',
  './js/dashboard-v2-init.js','./js/web-sidebar-v2.js','./js/dashboard-home.js','./js/dashboard-duyuru.js','./js/dashboard-home-shared.js','./js/dashboard-home-enhancements.js','./js/role-ui-hardening.js',
