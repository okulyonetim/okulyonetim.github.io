...
const CACHE_ADI='oy-cache-v1134';
...
const ONBELLEGE_ALINACAKLAR=[
  ...
  './css/design-system.css?v=1069','./css/design-system.css','./css/dashboard-announcement-media.css?v=921','./js/app-loader.js?v=1038','./js/modules/academic.js?v=882','./js/modules/communication.js?v=839',
'./css/dashboard-announcement-media.css',
  ...
  './js/modules/rubric-settings.js?v=1062','./js/modules/rubric-tools.js','./js/modules/rubric-tools-engine.js',
