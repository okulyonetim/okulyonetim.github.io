...
const ONBELLEGE_ALINACAKLAR=[
  ...
  './js/firebase-init.js','./js/core/core.js','./js/core/platform/widget-adapter.js','./js/modules/report-engine.js',
  './js/modules/rubric-settings.js','./js/modules/rubric-tools.js','./js/modules/rubric-tools-v2-engine.js',
  './js/dokuman-okuyucu.js','./js/modules/document-viewer.js',
...
messaging.onBackgroundMessage(payload=>{
  ...
  return self.registration.showNotification(n.title||'Koruk İlk-Ortaokulu',{
    ...
    icon:n.icon||'./assets/icon-192.png',badge:'./assets/icon-192.png',data:{url:data.url||data.link||'./'}
  });
});
