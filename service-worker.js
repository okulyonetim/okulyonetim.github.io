...
const CACHE_ADI='oy-cache-v1052';
...
const ONBELLEGE_ALINACAKLAR=[
  ...
  './css/design-system.css?v=974','./css/dashboard-announcement-media.css?v=921','./js/app-loader.js?v=1036','./js/modules/academic.js?v=882','./js/modules/communication.js?v=839',
