...
.btn:not(.btn-primary):not(.btn-amber):not(.btn-danger),.btn-ghost{background:var(--contrast-surface)!important;color:var(--contrast-text)!important;border-color:var(--contrast-border)!important}
.btn:not(.btn-primary):not(.btn-amber):not(.btn-danger):hover,.btn-ghost:hover,.btn:not(.btn-primary):not(.btn-amber):not(.btn-danger):focus-visible,.btn-ghost:focus-visible{background:var(--contrast-surface-alt)!important;color:var(--contrast-text)!important}
...
input,select,textarea{color:var(--contrast-text)!important;background:var(--contrast-surface-alt)!important;border-color:var(--contrast-border)!important}
