...
function yoklamaDevamsizlarKapat(){const anaAcik=!!document.getElementById('yokOverlay');document.getElementById('yokDevamsizOverlay')?.remove();if(!anaAcik)document.body.classList.remove('yok-modern-open');if(typeof _pullToRefreshAyarla==='function')_pullToRefreshAyarla(!anaAcik)}
