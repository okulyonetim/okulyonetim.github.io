...
function shell(){return `<section class="ka-stack" data-transport-module><div class="ka-row ka-row--between"><div><h2>Taşıma</h2><p class="ka-muted">Taşıma ve oturma planları tek bölümden yönetilir.</p></div><span id="transportCount" class="ka-badge"></span></div><nav class="ka-row ka-wrap transport-module-nav" aria-label="Taşıma"><button class="ka-btn ka-btn--sm" type="button" data-transport-page="services">🚌 Servisler</button><button class="ka-btn ka-btn--sm ka-btn--secondary" type="button" data-transport-page="busSeats">💺 Servis Oturma</button></nav><label class="ka-field"><span class="ka-field__label">Ara</span><input id="transportSearch" type="search" placeholder="Servis, plaka, güzergâh veya sınıf ara…"></label><div id="transportContent" class="ka-stack"></div></section>`}
