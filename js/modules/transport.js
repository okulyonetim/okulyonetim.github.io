...
function sbeTableConfig(){
  ...
  const colWidths=Array.from({length:cols},(_,i)=>Math.max(70,Number(old.colWidths?.[i])||Math.max(82,Math.floor(330/cols))));
