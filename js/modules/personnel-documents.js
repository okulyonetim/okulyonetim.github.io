...
.pd-doc{font-family:"Times New Roman",Times,serif;font-size:12pt;line-height:1.5;color:#000}.pd-head{text-align:center;margin:0 0 28mm}.pd-head>*{display:block}.pd-head strong{font-size:12pt}.pd-title{text-align:center;font-weight:700;text-decoration:underline;margin:0 0 8mm}.pd-info{width:auto!important;margin:0 0 8mm;border-collapse:collapse!important;table-layout:auto!important;background:#fff!important}.pd-info tr,.pd-info tr:nth-child(odd),.pd-info tr:nth-child(even){background:#fff!important;box-shadow:none!important}.pd-info td{border:0!important;background:#fff!important;color:#000!important;font-size:12pt!important;padding:1.2mm 0!important;vertical-align:top!important}.pd-info td:first-child{width:45mm!important;max-width:45mm!important;font-weight:700;padding-right:2mm!important;white-space:nowrap}.pd-info td:nth-child(2){width:4mm!important;padding-right:2mm!important;text-align:center!important}.pd-info td:nth-child(3){width:auto!important;white-space:nowrap!important}.pd-p{margin:0 0 7mm;text-align:justify}.pd-indent{text-indent:10mm}.pd-bottom{display:flex;justify-content:space-between;gap:10mm;align-items:flex-start;margin-top:14mm}.pd-address{flex:1}.pd-sign{text-align:center;min-width:52mm}.pd-sign>*{display:block}.pd-sign .pd-sign-space{height:6mm}.pd-gap{margin-top:6mm}
</style>`}
