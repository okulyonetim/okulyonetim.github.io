...
function currentClassId(){const detail=$('.ka-class-detail');if(!detail)return'';const name=$('.ka-detail-topbar h2',detail)?.textContent?.trim()||'';return classByName(name)?.id||''}
