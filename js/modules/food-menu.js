...
const FOOD_MENU_STYLE='<style>'
 ...
 +'.food-item-row input{width:100%;min-width:0;box-sizing:border-box;padding:8px 12px;border-radius:14px;border:1px solid var(--ka-input-border)!important;font-size:15px;background:var(--ka-input-bg)!important;color:var(--ka-input-text)!important;-webkit-text-fill-color:var(--ka-input-text)!important;caret-color:var(--ka-primary);color-scheme:var(--ka-color-scheme);box-shadow:none!important;}[data-theme="dark"] [data-food-menu-module] .food-item-row input{background:var(--ka-input-bg)!important;color:var(--ka-input-text)!important;-webkit-text-fill-color:var(--ka-input-text)!important;border-color:var(--ka-input-border)!important;}'
...
const FOOD_PRINT_STYLE='<style>'
 +'.fm-print{font-family:Arial,Helvetica,sans-serif;color:var(--ka-report-text);width:100%}'
