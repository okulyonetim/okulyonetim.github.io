...
function render(){if(!mounted)return;if(active==='map')renderMap();else if(active==='forms')renderForms();else if(active==='attendance')renderAttendance();else renderChecklists()}
