...
function closeAttendance(){if(!document.getElementById('yokOverlay'))return false;if(typeof window.yoklamaKapat==='function')window.yoklamaKapat();else document.getElementById('yokOverlay')?.remove();return true}
