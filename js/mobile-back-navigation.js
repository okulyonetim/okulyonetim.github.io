...
function closeOncCreate(){const ov=document.getElementById('oncModal');if(!ov)return false;ov.remove();document.body.classList.remove('onc-modal-open');return true}
function closeOncDetail(){const ov=document.getElementById('oncDetayOverlay');if(!ov)return false;if(typeof window.oncDetayKapatIste==='function')window.oncDetayKapatIste();else ov.remove();return true}
