...
function injectStyles(){
  ...
  s.textContent=`
    ...
    [data-admin-settings-page="admin-info"]{max-width:760px;margin:0 auto;padding-bottom:18px;overflow-x:hidden}
    .ka-admin-info-hero{display:flex;gap:12px;align-items:center;padding:16px;border:1px solid var(--ka-border,#dce8e2);border-radius:20px;background:linear-gradient(135deg,rgba(22,118,79,.13),rgba(22,118,79,.035))}
    .ka-admin-info-hero__icon{width:48px;height:48px;border-radius:15px;display:grid;place-items:center;background:rgba(22,118,79,.15);font-size:24px;flex:0 0 auto}
    .ka-admin-info-hero__copy{min-width:0;flex:1}.ka-admin-info-hero__copy strong{display:block;font-size:1.05rem}.ka-admin-info-hero__copy small{display:block;margin-top:4px;color:var(--ka-muted,#7d8c86)}
