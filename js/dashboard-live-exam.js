/* Koruk Asistan — Ana sayfa canlı deneme kartı
 * Tek DOM sahibi. Runtime/cache verisini kullanır; local stop-state hazır olmadan aktif kart çizmez.
 */
(function(){
'use strict';
if(window.__KH_LIVE_EXAM_CARD__)return;window.__KH_LIVE_EXAM_CARD__=true;
