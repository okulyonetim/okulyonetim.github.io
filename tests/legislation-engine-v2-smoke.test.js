...
assert(!sw.includes('js/modules/legislation')&&sw.includes("const CACHE_ADI='oy-cache-v939';"),'Service Worker Mevzuat dosyalarını önbelleğe almamalı ve cache yükseltilmeli.');
