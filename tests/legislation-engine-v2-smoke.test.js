...
const cache=sw.match(/const CACHE_ADI='oy-cache-v(\d+)';/);assert(!sw.includes('js/modules/legislation')&&cache&&Number(cache[1])>=940,'Service Worker Mevzuat dosyalarını önbelleğe almamalı ve cache sürümü 940 veya üzeri olmalı.');
