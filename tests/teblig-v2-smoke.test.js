...
assert(index.includes('<script src="js/modules/report-engine.js" defer></script>'),'ReportEngine uygulama shell servisinde hazır olmalı.');

console.log('Documents V2 Tebliğ-Tebellüğ + ReportEngine sözleşmesi başarılı.');
