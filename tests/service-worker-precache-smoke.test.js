...
assert(sw.includes("const CACHE_ADI = 'oy-cache-v444'"), 'Service Worker cache sürümü v444 olmalı.');
...
assert(sw.includes("'./js/role-ui-hardening.js'"), 'Rol/yetki sertleştirme katmanı precache edilmeli.');
