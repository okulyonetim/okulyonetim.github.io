...
for(const page of ['school','lesson-hours','holiday','lesson-list','branch-list','users','statistics','account','sync','roles','app','reminders','storage','admin-info'])assert(settings.includes(`'${page}'`),`Settings sayfa hedefi eksik: ${page}`);
...
assert(shell.includes("name==='settings'&&['school','lesson-hours','holiday','users','statistics','account','sync','roles','app','reminders','storage','admin-info'].includes(page)"),'Shell Settings alt sayfalarını, Tatil Modu ve İdari Bilgiler dahil, doğrudan route etmeli.');
