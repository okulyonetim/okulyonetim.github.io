...
assert(settings.includes('data-lesson-holiday')&&settings.includes('data-lesson-opening-date')&&settings.includes('data-lesson-holiday-message')&&settings.includes('tatilModuNotu')&&settings.includes('okulAcilisTarihi')&&settings.includes('Tatil modu için okulun açılacağı tarihi seçin.'),'Tatil modu açılış tarihini zorunlu seçtirmeli ve mevcut tatil mesajı alanını yönetmeli.');
assert(live.includes('function holidayState(cfg,now,segments)')&&live.includes('okulAcilisTarihi')&&live.includes('remainingDays')&&live.includes('countdownLabel')&&live.includes('openingLabel')&&live.includes('tatilModuNotu')&&live.includes('today>=opening'),'Canlı zil motoru tatil mesajı/açılış tarihi/gün sayacını tek kaynaktan okuyup açılış gününde yeniden devreye girmeli.');
