...
assert(loader.includes("define('academic',[FIREBASE_STORAGE_SDK,'js/modules/report-engine.js','js/modules/academic.js?v=876'])"),'Academic loader yalnız Storage SDK + ReportEngine + canonical Academic yüklemeli.');
