...
new Function(sw);
assert(sw.includes("const CACHE_ADI='oy-cache-v1070'"),'Service Worker cache sürümü güncellenmeli.');
...
assert(sw.includes("./css/design-system.css?v=992"),'Güncel merkezi tema CSS kaynağı önbelleğe alınmalı.');
