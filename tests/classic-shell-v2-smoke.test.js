...
assert((shell.match(/<link\s+rel=\"stylesheet\"/g)||[]).length===1&&shell.includes('<link rel=\"stylesheet\" href=\"css/design-system.css?v=866\">'),'Production shell yalnız tek merkezi css/design-system.css yüklemeli.');
