...
assert((shell.match(/<link\s+rel=\"stylesheet\"/g)||[]).length===1&&/<link rel=\"stylesheet\" href=\"css\/design-system\.css\?v=\d+\">/.test(shell),'Production shell yalnız tek sürümlü merkezi css/design-system.css yüklemeli.');
