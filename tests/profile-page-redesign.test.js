...
assert(index.includes('css/design-system.css?v=864'),'Profil tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v864'")&&sw.includes('./css/design-system.css?v=864'),'Yeni profil tasarımı PWA cache sürümüyle yayınlanmalı.');
