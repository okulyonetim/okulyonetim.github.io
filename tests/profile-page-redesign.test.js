...
assert(index.includes('css/design-system.css?v=865'),'Profil tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v865'")&&sw.includes('./css/design-system.css?v=865'),'Yeni profil tasarımı PWA cache sürümüyle yayınlanmalı.');
