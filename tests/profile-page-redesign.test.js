...
assert(index.includes('css/design-system.css?v=868'),'Profil tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v868'")&&sw.includes('./css/design-system.css?v=868'),'Yeni profil tasarımı PWA cache sürümüyle yayınlanmalı.');
