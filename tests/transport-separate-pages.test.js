...
assert(loader.includes("define('transport',['js/modules/report-engine.js','js/modules/transport.js?v=905'])"),'Transport yalnız canonical UI + ortak ReportEngine ile lazy yüklenmeli.');
