...
for(const token of ["key:'rubric'","script:'js/kriter-dagitim.js'","api:'KriterDagitimAraci'","key:'project'","script:'js/proje-degerlendirme.js'","api:'ProjeDegerlendirmeAraci'","global.AppLoader.loadScript(def.script)","data.rubricTool=def.key"]){
