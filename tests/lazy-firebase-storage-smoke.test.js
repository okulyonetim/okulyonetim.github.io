...
assert(/define\('dashboard',\['js\/modules\/school-live-status\.js','js\/modules\/communication\.js(?:\?v=\d+)?','js\/modules\/dashboard\.js'\]\)/.test(loader),'Dashboard duyuru okundu işlemi için mevcut tek Communication servis sahibini kullanmalı; ikinci DuyurularService üretmemeli.');
