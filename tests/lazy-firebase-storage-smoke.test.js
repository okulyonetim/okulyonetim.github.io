...
assert(/define\('communication',\[FIREBASE_STORAGE_SDK,'js\/modules\/communication\.js(?:\?v=\d+)?','js\/modules\/assistant\.js'\]\)/.test(loader),'Mesajlaşma Storage SDK yüklenmeden açılmamalı.');
