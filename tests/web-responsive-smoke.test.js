...
// Yeni web v2 katmanı: desktop-only controller, mobil v4 ile çakışmamalı.
...
assert(webInit.includes("matchMedia('(min-width: 1024px)')"), 'Web init masaüstü breakpointiyle korunmalı.');
...
assert(webInit.includes('wsSidebarToggle'), 'Web sidebar daraltma kontrolü bulunmalı.');
