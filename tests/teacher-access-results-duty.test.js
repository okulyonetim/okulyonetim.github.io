...
assert(index.includes('css/design-system.css?v=877')&&index.includes('js/core/shell-ui.js?v=877')&&index.includes('js/app-loader.js?v=877'),'Değişen kabuk kaynakları v876 ile cache-bust edilmeli.');
assert(loader.includes("'js/modules/academic.js?v=877'")&&loader.includes("define('settings',['js/modules/settings.js?v=877'])"),'Değişen lazy modüller v876 ile yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v877'")&&sw.includes('./js/modules/settings.js?v=877'),'Service Worker v876 kaynaklarını önbelleğe almalı.');
