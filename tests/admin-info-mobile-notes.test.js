...
assert(src.includes('IdariBilgilerRepository')&&src.includes('IdariBilgilerService'),'İdari bilgiler Repository/Service katmanında değil.');
assert(src.includes("device().set('idariBilgiler'"),'İdari bilgiler DeviceData üzerinden yazılmıyor.');
assert(src.includes("SyncEngine.register(t,c)")&&src.includes("idariBilgiler:COL.idariBilgiler"),'İdari bilgiler SyncEngine kaydı eksik.');
