...
assert(index.includes('css/design-system.css?v=871')&&index.includes('js/app-loader.js?v=860'),'Üretim shell güncel cache-bust sürümünü kullanmalı.');
assert(loader.includes('js/modules/academic.js?v=838'),'Academic loader v838 kullanmalı.');
assert(sw.includes("const CACHE_ADI='oy-cache-v871'"),'Service Worker güncel cache sürümünü kullanmalı.');
