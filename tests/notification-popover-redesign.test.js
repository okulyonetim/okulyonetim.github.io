...
assert(index.includes('css/design-system.css?v=867'),'Yeni bildirim tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v867'")&&sw.includes('./css/design-system.css?v=867'),'Bildirim tasarımı yeni PWA cache sürümüyle yayınlanmalı.');
