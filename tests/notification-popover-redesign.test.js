...
assert(index.includes('css/design-system.css?v=866'),'Yeni bildirim tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v866'")&&sw.includes('./css/design-system.css?v=866'),'Bildirim tasarımı yeni PWA cache sürümüyle yayınlanmalı.');
