...
assert(index.includes('css/design-system.css?v=865'),'Yeni bildirim tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v865'")&&sw.includes('./css/design-system.css?v=865'),'Bildirim tasarımı yeni PWA cache sürümüyle yayınlanmalı.');
