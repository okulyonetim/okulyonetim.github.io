...
assert(index.includes('css/design-system.css?v=869'),'Yeni bildirim tasarımı güncel merkezi CSS sürümüyle yüklenmeli.');
assert(sw.includes("const CACHE_ADI='oy-cache-v869'")&&sw.includes('./css/design-system.css?v=869'),'Bildirim tasarımı yeni PWA cache sürümüyle yayınlanmalı.');
