...
for(const [name,file] of Object.entries({dashboard:'dashboard.js',people:'people.js',academic:'academic.js?v=836',management:'management.js',communication:'communication.js?v=836',transport:'transport.js',documents:'documents.js',tools:'tools.js',settings:'settings.js'})) assert(registry(name).includes(`'js/modules/${file}'`),`${name} kendi tek UI modülünü yüklemeli.`);
