...
assert(css.includes('[data-theme="dark"]')&&css.includes('--ka-primary:#ffc400')&&css.includes('.ka-theme-picker'),'Tek Design System zümrüt koyu temayı ve merkezi görünüm bileşenini taşımalı.');
