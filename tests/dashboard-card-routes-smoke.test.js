...
assert(css.includes('[data-theme="dark"]')&&css.includes('--ka-primary:#38bdf8')&&css.includes('--ka-module-communication-1:#fb7185')&&css.includes('.ka-theme-picker'),'Tek Design System yeni renkli koyu temayı ve merkezi görünüm bileşenini taşımalı.');
