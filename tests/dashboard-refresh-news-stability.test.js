...
assert(core.includes('installPullToRefreshAdapter')&&core.includes("window.__kaUnifiedPullRefresh=true")&&core.includes('SyncEngine?.sync'),'Güncel native pull-refresh platform adaptörü korunmalı.');
