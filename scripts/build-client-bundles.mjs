...
const bundles={
  'data.js':['js/modules/duty-data.js','js/modules/settings-data.js','js/modules/transport-data.js','js/modules/tools-data.js'],
...
const manifest={version:18,generatedAt:new Date().toISOString(),bundles:{}};
