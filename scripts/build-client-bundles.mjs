...
const bundles={
  'data.js':['js/modules/duty-data.js','js/modules/settings-data.js','js/modules/management-data.js','js/modules/messaging-data.js','js/modules/communication-data.js','js/modules/transport-data.js','js/modules/documents-data.js','js/modules/tools-data.js'],
...
const manifest={version:15,generatedAt:new Date().toISOString(),bundles:{}};
