...
const bundles={
  'data.js':['js/modules/duty-data.js','js/modules/settings-data.js','js/modules/transport-data.js'],
...
const manifest={version:20,generatedAt:new Date().toISOString(),bundles:{}};
