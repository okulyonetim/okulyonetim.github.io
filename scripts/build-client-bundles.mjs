...
const bundles={
  'data.js':['js/modules/duty-data.js','js/modules/people-data.js','js/modules/settings-data.js','js/modules/academic-data.js','js/modules/management-data.js','js/modules/messaging-data.js','js/modules/communication-data.js','js/modules/transport-data.js','js/modules/documents-data.js'],
...
const manifest={version:10,generatedAt:new Date().toISOString(),bundles:{}};
